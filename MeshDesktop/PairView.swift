...
struct PairView: View {
    ...
    private func details(for code: LocalDaemon.PairCode) -> some View {
        VStack(spacing: 10) {
            ...
            Text("Point the iPhone's Camera app at the square and tap the banner. No QR reader? Open LeSearch AI → Machines → Add machine and type the code. It works once.")
                .font(.caption)
                .foregroundStyle(.secondary)
