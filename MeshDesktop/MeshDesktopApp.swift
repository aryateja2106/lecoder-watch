// MeshDesktopApp.swift — LeSearch AI in the Mac menu bar.
//
...
struct MeshDesktopApp: App {
    ...
    var body: some Scene {
        ...
        MenuBarExtra("LeSearch AI", systemImage: daemon.up ? "circle.fill" : "circle") {
            MenuContent()
...
private struct MenuContent: View {
    ...
    var body: some View {
        ...
        Button("Quit LeSearch AI") { NSApp.terminate(nil) }
            .keyboardShortcut("q")
    }
