...
| [screen-crawler.md](screen-crawler.md) | Walking every screen of an app (ours or a competitor's) per release, annotating each with a local model, diffing releases | Design + phased build plan; phase 1 runs on the simulator. |
