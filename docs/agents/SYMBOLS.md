...
| apiStatus | function | install/payload/bin/mesh:1117 |
...
| appsErr | function | install/payload/bin/mesh:1655 |
| AppsLibraryView | struct | iOS/AppsLibraryView.swift:11 |
| appsOk | function | install/payload/bin/mesh:1651 |
...
| cmdApps | function | install/payload/bin/mesh:1673 |
| cmdAppsAdd | function | install/payload/bin/mesh:1845 |
| cmdAppsConfig | function | install/payload/bin/mesh:1804 |
| cmdAppsInstall | function | install/payload/bin/mesh:1942 |
| cmdAppsList | function | install/payload/bin/mesh:1876 |
| cmdAppsOta | function | install/payload/bin/mesh:1704 |
| cmdAppsPublish | function | install/payload/bin/mesh:1818 |
| cmdAppsPush | function | install/payload/bin/mesh:1925 |
| cmdAppsRemove | function | install/payload/bin/mesh:1884 |
| cmdCp | function | install/payload/bin/mesh:158 |
| cmdDesktop | function | install/payload/bin/mesh:1310 |
| cmdDoctor | function | install/payload/bin/mesh:429 |
| cmdEvents | function | install/payload/bin/mesh:450 |
| cmdExposures | function | install/payload/bin/mesh:507 |
| cmdHealth | function | install/payload/bin/mesh:374 |
| cmdHooks | function | install/payload/bin/mesh:1416 |
...
| cmdPair | function | install/payload/bin/mesh:583 |
| cmdPeek | function | install/payload/bin/mesh:308 |
| cmdSend | function | install/payload/bin/mesh:320 |
| cmdSetup | function | install/payload/bin/mesh:1330 |
| cmdShellenv | function | install/payload/bin/mesh:1320 |
| cmdSkills | function | install/payload/bin/mesh:1539 |
| cmdStatus | function | install/payload/bin/mesh:392 |
| cmdTokenRotate | function | install/payload/bin/mesh:1300 |
| cmdTokenRotateLocal | function | install/payload/bin/mesh:1146 |
| cmdTokenRotateRemote | function | install/payload/bin/mesh:1249 |
| cmdUninstall | function | install/payload/bin/mesh:2040 |
| cmdUpgrade | function | install/payload/bin/mesh:1046 |
| cmdUpgradeLocal | function | install/payload/bin/mesh:938 |
| cmdUpgradeRemote | function | install/payload/bin/mesh:1013 |
...
| confirmOrDie | function | install/payload/bin/mesh:1128 |
...
| download | function | install/payload/bin/mesh:665 |
...
| externalFootprint | function | install/payload/bin/mesh:1975 |
...
| firstPairedIphoneUdid | function | install/payload/bin/mesh:1902 |
...
| freePort | function | install/payload/bin/mesh:720 |
...
| help | function | install/payload/bin/mesh:2334 |
...
| hooksInstalled | function | install/payload/bin/mesh:1410 |
...
| isMeshManagedDir | function | install/payload/bin/mesh:1527 |
...
| linkedClientCount | function | install/payload/bin/mesh:1532 |
...
| listSkillNames | function | install/payload/bin/mesh:1518 |
...
| loadAppsConfig | function | install/payload/bin/mesh:1636 |
...
| lstatOrNull | function | install/payload/bin/mesh:1526 |
...
| main | function | install/payload/bin/mesh:2341 |
...
| mintToken | function | install/payload/bin/mesh:1069 |
...
| packageIpa | function | install/payload/bin/mesh:1768 |
...
| pairQR | function | install/payload/bin/mesh:562 |
...
| plistValue | function | install/payload/bin/mesh:1758 |
| pointerGain | func | Shared/Models.swift:1305 |
| pointerScreenPosition | func | Shared/ScreenZoom.swift:50 |
| pollVersion | function | install/payload/bin/mesh:925 |
...
| randomHex | function | install/payload/bin/mesh:1645 |
| rcFilesWithMeshLines | function | install/payload/bin/mesh:1990 |
| ReachabilityAlertGate | struct | Shared/AlertGating.swift:9 |
| reachableAddress | function | install/payload/bin/mesh:541 |
| readAllAppMeta | function | install/payload/bin/mesh:1793 |
| readAppMeta | function | install/payload/bin/mesh:1661 |
| readClaudeSettings | function | install/payload/bin/mesh:1404 |
...
| restartDaemon | function | install/payload/bin/mesh:894 |
...
| run | function | install/payload/bin/mesh:533 |
| runError | function | install/payload/meshd/herdr.ts:71 |
| runOk | function | install/payload/bin/mesh:654 |
| SafariView | struct | iOS/FileBrowserView.swift:358 |
| saveAppsConfig | function | install/payload/bin/mesh:1640 |
...
| setSupervisorToken | function | install/payload/bin/mesh:1095 |
...
| skillsPayloadDir | function | install/payload/bin/mesh:1512 |
| smokeTest | function | install/payload/bin/mesh:734 |
| snapshotMachineMatching | func | Shared/Models.swift:167 |
| stagePayload | function | install/payload/bin/mesh:688 |
...
| stopService | function | install/payload/bin/mesh:2026 |
| StoreError | struct | iOS/MeshStore.swift:10 |
| String | extension | iOS/ShellSafeText.swift:20 |
| stripRcLines | function | install/payload/bin/mesh:2005 |
| SuggestionChip | struct | iOS/AgentChatView.swift:1165 |
| swapInMeshd | function | install/payload/bin/mesh:773 |
| SwiftTermView | struct | iOS/NativeTerminalScreen.swift:406 |
| SwiftUI | extension | iOS/NativeTerminalScreen.swift:350 |
| syncAgyHooks | function | install/payload/bin/mesh:1471 |
| syncBin | function | install/payload/bin/mesh:786 |
| syncBridgePage | function | install/payload/bin/mesh:842 |
| syncHooks | function | install/payload/bin/mesh:821 |
...
| tailscaleBin | function | install/payload/bin/mesh:1699 |
...
| treeVersion | function | install/payload/bin/mesh:660 |
...
| uninstallSkills | function | install/payload/bin/mesh:1595 |
...
| utcStamp | function | install/payload/bin/mesh:1076 |
| verifyDigest | function | install/payload/bin/mesh:673 |
...
| writeAppMeta | function | install/payload/bin/mesh:1667 |
| writeDaemonEnv | function | install/payload/bin/mesh:873 |
| writeTokenFile | function | install/payload/bin/mesh:1081 |
