...
|---|---|---|---|
| GET | `/a/*` | none | server.ts:1303 |
| ANY | `/agents` | token | server.ts:1372 |
| DELETE | `/agents/:x` | token | server.ts:1445 |
| GET | `/agents/:x/chat` | token | server.ts:1415 |
| POST | `/agents/:x/handoff` | token | handoff.ts:287 |
| GET | `/agents/:x/output` | token | server.ts:1422 |
| GET | `/agents/:x/panes` | token | server.ts:1402 |
| POST | `/agents/:x/panes` | token | server.ts:1406 |
| DELETE | `/agents/:x/panes/:x` | token | server.ts:1440 |
| GET | `/agents/:x/resumable` | token | handoff.ts:281 |
| POST | `/agents/:x/send` | token | server.ts:1434 |
| POST | `/agents/new` | token | server.ts:1449 |
...
| GET | `/events` | token | server.ts:1374 |
| POST | `/events` | token | server.ts:1375 |
...
| ANY | `/health` | none | server.ts:1291 |
| GET | `/input` | token | input.ts:474 |
| POST | `/input` | token | input.ts:477 |
| POST | `/kb` | token | server.ts:1383 |
| PUT | `/kb` | token | server.ts:1383 |
| GET | `/kb/:x/:x` | token | server.ts:1397 |
| GET | `/kb/search` | token | server.ts:1387 |
...
| ANY | `/stats` | token | server.ts:1370 |
| POST | `/system` | token | input.ts:557 |
| ANY | `/tailnet` | token | server.ts:1371 |
| ANY | `/usage` | token | server.ts:1373 |
| GET | `/volume` | token | input.ts:562 |
| POST | `/volume` | token | input.ts:562 |
| POST | `/wake` | token | server.ts:1360 |
