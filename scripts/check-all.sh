...
DEPS="$ROOT/Shared/Models.swift $ROOT/Shared/LimitHelpers.swift $ROOT/Shared/AgentNotifications.swift $ROOT/Shared/WatchGlance.swift $ROOT/Shared/APNsEnvironment.swift $ROOT/Shared/RiskClassifier.swift $ROOT/Shared/ScreenZoom.swift $ROOT/Shared/AlertGating.swift $ROOT/Shared/DaemonCapabilities.swift"
