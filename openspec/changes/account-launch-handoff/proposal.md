...
- Rebuilding any finished draft named in the design table. That includes the account pages, the identity SQL, the node seal/open helper (pull request 138), the Swift seal check (pull request 141), the menu-bar sealed upload bodies (pull request 152; that file is not in the Xcode target), the key file, the note draft, the Jev filter, the account flow check (pull request 158), the sealed mailbox round trip (pull request 159), the route-gated draft (pull request 160), spoken note in (pull request 162), spoken note to a held file (pull request 164), the account handlers (pull request 165), sealed sync isolation (pull request 166), local sign-up (pull request 167), account delete cascade (pull request 168), the pairing-code hold (pull request 169), and account pages on local auth (pull request 170). Those drafts are the implementation. Re-check each pull request tip before touching the same files, and do not open a second copy.
