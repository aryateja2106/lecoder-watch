...
- **WHEN** an agent reads pull request 167, 170, 171, 172, 175, or 177
...
- **AND** the agent re-checks pull request 177 with `gh pr checks 177` before calling apps (Xcode) green again
