...
- **WHEN** an agent is about to claim both jobs are green on `ae83b95`
- **THEN** the agent records that daemon CI is green on `ae83b95` (check run `35747085140`) while apps (Xcode) is still running
