...
- **THEN** the agent records that daemon CI and Xcode CI are both green on `bd04cc0` (check run `35743446950`) and on handoff tips `dcfa77f` (check run `35744449505`) and `b3e9160` (check run `35745531307`)
- **AND** the agent says that this does not prove a microphone, a speaker, or that a paper was read
